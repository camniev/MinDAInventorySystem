		...
		<div>
			<div class="card" style="background: #A9D0F5; margin-left: -5px;">
				<div class="card-header">
					<div class="card-header" style="background: #08298A; color: #ffffff"><Strong>Items/Stock Card</Strong></div>
						...
						<div class="mt-4" style="float: right;"><button onclick="window.history.back();"  class="btn btn-small btn-primary"><span class="fa fa-chevron-left"> Back</span></button></div>
				</div>
			</div>
		</div>
	</div>
